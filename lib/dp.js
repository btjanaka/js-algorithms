 ...
 * @param {array} slices The list of slices of pizza
 * @return {int} The max difference in pizza eaten
 */
 ...
 * stone?
 * @param {int} n The number of stones
 * @return {bool} Whether you can win
 */
function nStones(n) {
 ...
 * @return {Object} ret - The results of the calculation
 * @return {number} ret.length - The length of the LCS
 * @return {string} ret.string - The actual LCS
 */
